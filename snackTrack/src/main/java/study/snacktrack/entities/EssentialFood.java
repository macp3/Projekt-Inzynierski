...
/**
 * Represents a basic, essential food item stored in the application's internal
 * database.
 * This entity contains the nutritional breakdown (macros and calories) and
 * descriptive details for one specific food source.
 */
@Entity
...
public class EssentialFood {
     ...
     * This empty constructor ensures the ORM framework can correctly load and
    ...
    /**
     * Constructs a new EssentialFood entity with all necessary nutritional and
     * descriptive details.
     * This parameterized constructor is typically used when saving a new
     * user-defined food item to the database.
     *
     ...
     */
    public EssentialFood(int id, @NotNull String name, int authorId, @NotNull String description, float calories,
            float protein, float fat, float carbohydrates, String servingSizeUnit, float defaultWeight,
            String brandName) {
        this.id = id;
        this.name = name;
     ...
     * EssentialFood entity properties.
     */
    public int getId() {
        return id;
    }
